...
router.post('/',
  ...
  [
    ...
    body('dateOfBirth').notEmpty().isISO8601().withMessage('Date of birth is required and must be valid'),
    body('gender').notEmpty().isIn(['male', 'female', 'other']).withMessage('Gender is required and must be male, female, or other'),
